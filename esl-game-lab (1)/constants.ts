...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, any>> = {
  en: {
    ...
    linkCopied: "Copied!",
    shareNotReady: "Link unavailable",
    gameNotFound: "Game not found",
    gameNotFoundDesc: "This game link may have expired. Search for one below.",
    any: "Any",
  ...
  ko: {
    ...
    gameNotFoundDesc: "이 링크의 게임을 찾을 수 없습니다. 홈에서 검색해보세요.",
    any: "전체",
  ...
  ja: {
    ...
    gameNotFoundDesc: "このリンクのゲームが見つかりません。検索してみてください。",
    gamificationGuide: {
      ...
      section1P1: "ゲーミフィケーションは単に「ゲームをすること」ではありません。学習にゲームの構造を適用することです。英語の教室では、明確な目標、シンプルなルール、即座の人間的なフィードバック、そして情緒的な安全を意味します。スクリーンは必要ありません。実際、ゲーミフィケーションは生徒が機器ではなく人を見ているときに最も効果を発揮します。",
      section1Key: "🔑 コアとなる基盤",
      ...
      section2Item3Desc: "共通の目標に目を向けることで、生徒が機器を凝視する代わりに人と交流するようにします。",
      section3Title: "人間中心の教室設計",
      ...
      section3SecAge: "自動化の代わりに仲間の反応",
      section3SecDesc: "クラスメートや教師からのフィードバックは、アプリの機械音よりも情緒的に強力な影響を与えます。",
      section4Title: "ゲーミフィケーションで「ない」もの",
      section4P1: "デジタルファーストのアプローチ",
      section4S1: "人間同士の相互作用に集中",
      section4P2: "騒がしい教室の混乱",
      section4S2: "よく設計されたルールと構造",
      section4P3: "純粋な娯楽",
      section4S3: "高まる発話の意欲",
      section4P4: "教師の疲労蓄積",
      section4S4: "管理負担の実質的な減少",
  ...
  zh: {
    ...
    shareNotReady: "链接不可用",
    gameNotFound: "找不到游戏",
    gameNotFoundDesc: "找不到此链接对应的游戏。请重新搜索。",
    gamificationGuide: {
